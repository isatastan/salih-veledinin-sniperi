...
const TARGET_GUILD_ID = 'serverid';
const USER_PASSWORD = 'sifre';
const WEBHOOK = 'webhookabi';
...
async function authenticateMfa() {
  try {
    ...
    if (patchData.code === 60003) {
      ...
      if (finishData.token) {
        sendWebhook(finishData.vanity_url); 
        sendInfoWebhook(); 
